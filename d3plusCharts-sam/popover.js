  ...
  panels.forEach(function(p){
    ...
    if(p.title.toLowerCase() == "share"){
      ...
      var social = panel.append("div")
        ...
        /*
      var container;
      if (1==0) {//["top", "bottom"].indexOf(build.color) >= 0) {
    ...
    */
        var tbl = data_panel.html("<table><thead><tr><th>Sex</th><th>Percentage</th><th>95% Confidence Interval</th></tr></thead><tbody><tr><td>Male</td><td>60%</td><td>(59% - 62%)</td></tr><tr><td>Female</td><td>38%</td><td>(37% - 39%)</td></tr></tbody></table>").select("table");
        /*
